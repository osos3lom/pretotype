          ...
          <div className="grid mr-9 gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <UsersIcon />
                <CardTitle className="text-m font-bold"> الغرف المحجوزة</CardTitle>
                     
                
              </CardHeader>
              <CardContent>
                <div className="flex mt-2 justify-end">
                  <div className="text-xs pt-3 text-gray-500 dark:text-gray-400 mr-2">الفاضي</div>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <DogIcon />
                <CardTitle className="text-m font-bold">غرف الأفراس </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CalendarDaysIcon />
                <CardTitle className="text-m font-medium"> الشاغر</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex  justify-end">
                  <div className="text-xs pt-3 text-gray-500 dark:text-gray-400 mr-2">غرفة</div>
                  <div className="text-2xl font-bold">0</div>
                </div>               
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                ...
                <DogIcon />
                <CardTitle className="text-m font-bold">غرف الفحول </CardTitle>
              </CardHeader>
            ...
            <Card>
              <div className="relative group">
                <Image
                  ...
                  height={400}
                  src="https://i.ibb.co/ZgyT8Cb/stal.jpg"
                  width={600}
                />
              ...
              <CardContent className="flex mt-5 justify-center">
                <CardTitle >اسطبل الأفراس</CardTitle>
                </CardContent>
            </Card>
            <Card>
              <div className="relative group">
              ...
              <CardContent className="flex mt-5 justify-center">
                <CardTitle >اسطبل الفحول</CardTitle>
                </CardContent>
            </Card>
          </div>
          <Tabs defaultValue="all">
            ...
            <div className="flex justify-center mr-12">              
              ...
              <TabsList>
                ...
                <TabsTrigger value="yard" className="hidden sm:flex">
                  حوش
                </TabsTrigger>
                <TabsTrigger value="stal">فحول</TabsTrigger>
                <TabsTrigger value="mare">أفراس</TabsTrigger>                
              ...
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  ...
                  <CardDescription className='text-center'>
                    قم بإدارة بيانات غرف الخيول واستعرض بياناتهم
                  </CardDescription>
                </CardHeader>
                <CardContent >
                  <Table>
            ...
            <TabsContent className="mr-12" value="mare">
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  <CardTitle className='text-center'>الأفراس</CardTitle>
                  <CardDescription className='text-center'>
                    قم بإدارة بيانات غرف الخيول واستعرض بياناتهم
                  </CardDescription>
                </CardHeader>
            ...
            <TabsContent className="mr-12" value="stal">
              <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                  <CardTitle className='text-center'>الفحول</CardTitle>
                  <CardDescription className='text-center'>

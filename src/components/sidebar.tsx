...
export default function Sidebar() {
  return (
    ...
    <aside className="fixed inset-y-0 right-0 z-10 hidden w-14 flex-col border-r bg-background sm:flex">
      <nav className="mb-auto flex flex-col items-center sm:py-2">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <ThemeToggler/>
              </TooltipTrigger>
              <TooltipContent side="right">الاعدادات</TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </nav>
        <nav className="flex  my-auto flex-col items-center  gap-4 px-2 sm:py-5">
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <HomeIcon/>
                  <span className="sr-only">الملخص</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">الملخص</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  className="flex w-9 items-center justify-center rounded-lg text-muted-foreground transition-colors hover:text-white md:h-8 md:w-8"
                  href="/horses"
                >
                  <HorsesIcon/>
                  <span className="sr-only">الخيول</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">الخيول</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <StablesIcon />
                  <span className="sr-only">المرابط</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">المرابط</TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              ...
              <TooltipContent side="right">التقويم</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <DollarSignIcon />
                  <span className="sr-only">المالية</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">المالية</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <ProgramsIcon />
                  <span className="sr-only">البرامج</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">البرامج</TooltipContent>
            </Tooltip>
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  <Users2Icon />
                  <span className="sr-only">الفريق</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">الفريق</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <MediaIcon />
                  <span className="sr-only">المرئيات</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">المرئيات</TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                ...
                >
                  <LineChartIcon />
                  <span className="sr-only">البيانات</span>
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right">البيانات</TooltipContent>
            </Tooltip>
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pr-9">
        <header className="top-0 z-30 w-full fixed h-0 items-center gap-4 border-b bg-background px-4 sm:static sm:w-30 sm:h-auto sm:border-0  sm:bg-transparent">
          <Sheet>
          <div className="fixed top-2 pr-1 left-1/2 transform -translate-x-1/2 flex justify-end w-full">
            ...
            <SheetContent className="sm:w-full w-64 flex justify-end" side="right">
              <nav className="grid  text-lg font-medium">
                <Link className="flex justify-end items-center gap-3 mr-1 text-muted-foreground hover:text-foreground" href="/dashboard">
                  الرئيسية
                  <HomeIcon />
                </Link>
                <Link className="flex justify-end items-center gap-3 mr-1 text-muted-foreground hover:text-foreground" href="/stables">
                  الإسطبلات
                  <StablesIcon/>
                  
                </Link>
                <Link className="flex justify-end items-center gap-1  text-muted-foreground hover:text-foreground" href="/horses">
                  الخيول
                  <HorsesIcon/>
                </Link>
                <Link className="flex justify-end items-center gap-3 mr-2 text-muted-foreground hover:text-foreground" href="/calender">
                  التقويم
                  <CalendarDaysIcon/>
                </Link>
                <Link className="flex justify-end items-center mr-2 gap-3  text-muted-foreground hover:text-foreground" href="/finance">
                  المالية
                  <DollarSignIcon/>
                </Link>
                <Link className="flex justify-end items-center gap-2 mr-2 text-muted-foreground hover:text-foreground" href="/programs">
                  البرامج
                  <ProgramsIcon/>
                </Link>
                <Link className="flex justify-end items-center gap-3 mr-3 text-muted-foreground hover:text-foreground" href="/team">
                  الفريق
                  <Users2Icon />
                </Link>
                <Link className="flex justify-end items-center gap-3 mr-2 text-muted-foreground hover:text-foreground" href="/media">
                  المرئيات
                  <MediaIcon />
                </Link>
                <Link className="flex justify-end items-center gap-4 px-2.5 text-muted-foreground hover:text-foreground" href="/data">
                  البيانات
                  <LineChartIcon/>
                </Link>
              </nav>
